//! Message 67 : Mouvement de produit - Prédétermination avec anticipation de purge multi-compartiments
...
const MESSAGE_NUM: u8 = 67;

/// Message 67 : Mouvement de produit - Prédétermination avec anticipation de purge multi-compartiments
#[derive(Default)]
pub struct Message67;

impl CommonMessageTrait for Message67 {
