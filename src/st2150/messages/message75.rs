//! Message 75 : Mouvement de produit - Transfert compartiment
...
const MESSAGE_NUM: u8 = 75;

/// Message 75 : Mouvement de produit - Transfert compartiment
#[derive(Default)]
pub struct Message75;

impl CommonMessageTrait for Message75 {
